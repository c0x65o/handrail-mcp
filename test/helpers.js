...
export const discovery = Object.freeze({
  ...
  policy: {
    allowed_modes: ["feature", "task"],
    delivery_ceiling: "intake_only",
...
export function requestRecord(overrides = {}) {
  return {
    ...
    effective_delivery_ceiling: "intake_only",
    title: "Add dashboard",
    status: "accepted",
    terminal: true,
    clarification_history: [],
    linked_pm_record: { type: "feature", id: "feature-001" },
    audit_lineage: [],
    terminal_evidence: { work_request_created: false, owner_goal_created: false },
    ...overrides,
  };
}
